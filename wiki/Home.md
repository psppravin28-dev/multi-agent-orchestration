...
Notes from working through the [multi-agent-orchestration](https://github.com/psppravin28-dev/multi-agent-orchestration)
repo module by module, written for someone who wants the concepts
explained from scratch rather than just the code. One page per module;
read them in order, alongside the actual exercise files in the repo.
...
order — see the repo's [main README](https://github.com/psppravin28-dev/multi-agent-orchestration#readme)).
Only *how they're coordinated* changes module to module:
